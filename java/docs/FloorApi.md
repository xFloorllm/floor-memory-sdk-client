...
<a id="editFloor"></a>
# **editFloor**
> EditFloor200Response editFloor(floorId, userId, appId, logoFile, title, details)
...
public class Example {
  public static void main(String[] args) {
    ...
    FloorApi apiInstance = new FloorApi(defaultClient);
    ...
    try {
      EditFloor200Response result = apiInstance.editFloor(floorId, userId, appId, logoFile, title, details);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FloorApi#editFloor");
...
# **getFloorInformation**
> FloorInfo getFloorInformation(floorId, appId, userId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FloorInfo result = apiInstance.getFloorInformation(floorId, appId, userId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FloorApi#getFloorInformation");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "appId_example"; // String | App ID
    try {
      EditFloor200Response result = apiInstance.makeFloorPrivate(floorId, userId, appId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FloorApi#makeFloorPrivate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "appId_example"; // String | App ID
    try {
      EditFloor200Response result = apiInstance.makeFloorPublic(floorId, userId, appId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FloorApi#makeFloorPublic");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      EditFloor200Response result = apiInstance.renameFloor(userId, appId, from, to);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FloorApi#renameFloor");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
