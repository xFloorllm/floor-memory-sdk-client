...
<a id="apiDeveloperCreateAppPost"></a>
...
<a id="apiDeveloperModifyAppPost"></a>
# **apiDeveloperModifyAppPost**
> Object apiDeveloperModifyAppPost(inputInfo, _file)
...
public class Example {
  public static void main(String[] args) {
    ...
    File _file = new File("/path/to/file"); // File | Upload the new PNG icon file.
    try {
      Object result = apiInstance.apiDeveloperModifyAppPost(inputInfo, _file);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#apiDeveloperModifyAppPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description | Notes |
|------------- | ------------- | ------------- | -------------|
| **inputInfo** | **String**| User ID, App ID, Title, Details. User ID and App ID are required parameters. Title/details are optional. |
|
| **_file** | **File**| Upload the new PNG icon file. | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ConversationThreads200Response result = apiInstance.conversationThreads(userId, floorId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#conversationThreads");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetConversations200Response result = apiInstance.getConversations(userId, threadId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#getConversations");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "appId_example"; // String | 
    try {
      SendValidationCode200Response result = apiInstance.sendValidationCode(mode, userId, mobileNumber, emailId, appId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DefaultApi apiInstance = new DefaultApi(defaultClient);
    String mobileNumber = "mobileNumber_example"; // String | Mobile number
    String passCode = "passCode_example"; // String | Pass code takes either password or validation code depending on the login_type
    String loginType = "loginType_example"; // String | 1 for password, 2 for activate code
    String appId = "appId_example"; // String | App ID
    try {
      SignInWithEmail200Response result = apiInstance.signInWithMobileNumber(mobileNumber, passCode, loginType, appId);
      System.out.println(result);
    } catch (ApiException e) {
...
|
| **passCode** | **String**| Pass code takes either password or validation code depending on the login_type |
|
| **loginType** | **String**| 1 for password, 2 for activate code |
|
| **appId** | **String**| App ID | [optional] |
