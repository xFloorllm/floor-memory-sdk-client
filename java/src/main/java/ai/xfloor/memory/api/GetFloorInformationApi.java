...
public class GetFloorInformationApi {
     ...
     */
    public GetFloorInformation200Response getFloorInformation(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId) throws ApiException {
        ApiResponse<GetFloorInformation200Response> localVarResp = getFloorInformationWithHttpInfo(floorId, appId, userId);
     ...
     */
    public ApiResponse<GetFloorInformation200Response> getFloorInformationWithHttpInfo(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId) throws ApiException {
     ...
     */
    public okhttp3.Call getFloorInformationAsync(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId, final ApiCallback<GetFloorInformation200Response> _callback) throws ApiException {
