...
public class EventApi {
     ...
     * @param appId App ID created in developer console. (required)
     ...
     */
    public okhttp3.Call eventCall(@javax.annotation.Nonnull String inputInfo, @javax.annotation.Nonnull String appId, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable List<File> files, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call eventValidateBeforeCall(@javax.annotation.Nonnull String inputInfo, @javax.annotation.Nonnull String appId, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable List<File> files, final ApiCallback _callback) throws ApiException {
        ...
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling event(Async)");
        }

        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling event(Async)");
        }

        return eventCall(inputInfo, appId, userId, files, _callback);
     ...
     */
    public EventResponse event(@javax.annotation.Nonnull String inputInfo, @javax.annotation.Nonnull String appId, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable List<File> files) throws ApiException {
     ...
     */
    public ApiResponse<EventResponse> eventWithHttpInfo(@javax.annotation.Nonnull String inputInfo, @javax.annotation.Nonnull String appId, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable List<File> files) throws ApiException {
     ...
     */
    public okhttp3.Call eventAsync(@javax.annotation.Nonnull String inputInfo, @javax.annotation.Nonnull String appId, @javax.annotation.Nonnull String userId, @javax.annotation.Nullable List<File> files, final ApiCallback<EventResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getRecentEventsCall(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRecentEventsValidateBeforeCall(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getRecentEvents(Async)");
        }

        return getRecentEventsCall(floorId, appId, userId, _callback);
     ...
     */
    public GetRecentEvents200Response getRecentEvents(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId) throws ApiException {
        ApiResponse<GetRecentEvents200Response> localVarResp = getRecentEventsWithHttpInfo(floorId, appId, userId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetRecentEvents200Response> getRecentEventsWithHttpInfo(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId) throws ApiException {
        okhttp3.Call localVarCall = getRecentEventsValidateBeforeCall(floorId, appId, userId, null);
     ...
     */
    public okhttp3.Call getRecentEventsAsync(@javax.annotation.Nonnull String floorId, @javax.annotation.Nonnull String appId, @javax.annotation.Nullable String userId, final ApiCallback<GetRecentEvents200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRecentEventsValidateBeforeCall(floorId, appId, userId, _callback);
        Type localVarReturnType = new TypeToken<GetRecentEvents200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
