...
public class EditFloor200Response {
  ...
  public EditFloor200Response() {
  }

  public EditFloor200Response floorId(@javax.annotation.Nonnull String floorId) {
  ...
  public EditFloor200Response title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public EditFloor200Response details(@javax.annotation.Nullable String details) {
  ...
  public EditFloor200Response floorUid(@javax.annotation.Nonnull String floorUid) {
  ...
  public EditFloor200Response blocks(@javax.annotation.Nullable List<BlockDetails> blocks) {
    this.blocks = blocks;
    return this;
  }

  public EditFloor200Response addBlocksItem(BlockDetails blocksItem) {
    if (this.blocks == null) {
  ...
  public EditFloor200Response avatar(@javax.annotation.Nullable Media avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public EditFloor200Response isOwner(@javax.annotation.Nonnull String isOwner) {
  ...
  public EditFloor200Response floorType(@javax.annotation.Nonnull String floorType) {
  ...
  public EditFloor200Response appId(@javax.annotation.Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EditFloor200Response editFloor200Response = (EditFloor200Response) o;
    return Objects.equals(this.floorId, editFloor200Response.floorId) &&
        Objects.equals(this.title, editFloor200Response.title) &&
        Objects.equals(this.details, editFloor200Response.details) &&
        Objects.equals(this.floorUid, editFloor200Response.floorUid) &&
        Objects.equals(this.blocks, editFloor200Response.blocks) &&
        Objects.equals(this.avatar, editFloor200Response.avatar) &&
        Objects.equals(this.isOwner, editFloor200Response.isOwner) &&
        Objects.equals(this.floorType, editFloor200Response.floorType) &&
        Objects.equals(this.appId, editFloor200Response.appId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditFloor200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EditFloor200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditFloor200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EditFloor200Response is not found in the empty JSON string", EditFloor200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditFloor200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EditFloor200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EditFloor200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EditFloor200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EditFloor200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EditFloor200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EditFloor200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EditFloor200Response>() {
           @Override
           public void write(JsonWriter out, EditFloor200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EditFloor200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EditFloor200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EditFloor200Response
   * @throws IOException if the JSON string is invalid with respect to EditFloor200Response
   */
  public static EditFloor200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EditFloor200Response.class);
  }

  /**
   * Convert an instance of EditFloor200Response to an JSON string
   *
   * @return JSON string
   */
