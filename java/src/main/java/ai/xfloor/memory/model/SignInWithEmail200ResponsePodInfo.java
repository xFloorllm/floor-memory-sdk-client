...
public class SignInWithEmail200ResponsePodInfo {
  ...
  public SignInWithEmail200ResponsePodInfo() {
  }

  public SignInWithEmail200ResponsePodInfo floorId(@javax.annotation.Nonnull String floorId) {
  ...
  public SignInWithEmail200ResponsePodInfo title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public SignInWithEmail200ResponsePodInfo details(@javax.annotation.Nullable String details) {
  ...
  public SignInWithEmail200ResponsePodInfo blocks(@javax.annotation.Nonnull List<BlockDetails> blocks) {
    this.blocks = blocks;
    return this;
  }

  public SignInWithEmail200ResponsePodInfo addBlocksItem(BlockDetails blocksItem) {
    if (this.blocks == null) {
  ...
  public SignInWithEmail200ResponsePodInfo avatar(@javax.annotation.Nullable Media avatar) {
    this.avatar = avatar;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignInWithEmail200ResponsePodInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignInWithEmail200ResponsePodInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignInWithEmail200ResponsePodInfo is not found in the empty JSON string", SignInWithEmail200ResponsePodInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignInWithEmail200ResponsePodInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignInWithEmail200ResponsePodInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SignInWithEmail200ResponsePodInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignInWithEmail200ResponsePodInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignInWithEmail200ResponsePodInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignInWithEmail200ResponsePodInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignInWithEmail200ResponsePodInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SignInWithEmail200ResponsePodInfo>() {
           @Override
           public void write(JsonWriter out, SignInWithEmail200ResponsePodInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignInWithEmail200ResponsePodInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignInWithEmail200ResponsePodInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignInWithEmail200ResponsePodInfo
   * @throws IOException if the JSON string is invalid with respect to SignInWithEmail200ResponsePodInfo
   */
  public static SignInWithEmail200ResponsePodInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignInWithEmail200ResponsePodInfo.class);
  }

  /**
   * Convert an instance of SignInWithEmail200ResponsePodInfo to an JSON string
   *
   * @return JSON string
   */
