...
public class SignUpResponse {
  ...
  public SignUpResponse userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public SignUpResponse success(@javax.annotation.Nonnull String success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, signUpResponse.userId) &&
        Objects.equals(this.success, signUpResponse.success);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignUpResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignUpResponse is not found in the empty JSON string", SignUpResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignUpResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignUpResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
