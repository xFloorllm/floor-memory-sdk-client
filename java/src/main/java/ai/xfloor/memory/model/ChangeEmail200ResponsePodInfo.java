...
public class ChangeEmail200ResponsePodInfo {
  ...
  public ChangeEmail200ResponsePodInfo() {
  }

  public ChangeEmail200ResponsePodInfo floorId(@javax.annotation.Nonnull String floorId) {
  ...
  public ChangeEmail200ResponsePodInfo isOwner(@javax.annotation.Nullable String isOwner) {
  ...
  public ChangeEmail200ResponsePodInfo appId(@javax.annotation.Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public ChangeEmail200ResponsePodInfo title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public ChangeEmail200ResponsePodInfo details(@javax.annotation.Nullable String details) {
  ...
  public ChangeEmail200ResponsePodInfo floorUid(@javax.annotation.Nonnull String floorUid) {
  ...
  public ChangeEmail200ResponsePodInfo blocks(@javax.annotation.Nonnull List<BlockDetails> blocks) {
    this.blocks = blocks;
    return this;
  }

  public ChangeEmail200ResponsePodInfo addBlocksItem(BlockDetails blocksItem) {
    if (this.blocks == null) {
  ...
  public ChangeEmail200ResponsePodInfo avatar(@javax.annotation.Nullable Media avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeEmail200ResponsePodInfo changeEmail200ResponsePodInfo = (ChangeEmail200ResponsePodInfo) o;
    return Objects.equals(this.floorId, changeEmail200ResponsePodInfo.floorId) &&
        Objects.equals(this.isOwner, changeEmail200ResponsePodInfo.isOwner) &&
        Objects.equals(this.appId, changeEmail200ResponsePodInfo.appId) &&
        Objects.equals(this.title, changeEmail200ResponsePodInfo.title) &&
        Objects.equals(this.details, changeEmail200ResponsePodInfo.details) &&
        Objects.equals(this.floorUid, changeEmail200ResponsePodInfo.floorUid) &&
        Objects.equals(this.blocks, changeEmail200ResponsePodInfo.blocks) &&
        Objects.equals(this.avatar, changeEmail200ResponsePodInfo.avatar);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeEmail200ResponsePodInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeEmail200ResponsePodInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeEmail200ResponsePodInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChangeEmail200ResponsePodInfo is not found in the empty JSON string", ChangeEmail200ResponsePodInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeEmail200ResponsePodInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChangeEmail200ResponsePodInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeEmail200ResponsePodInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeEmail200ResponsePodInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeEmail200ResponsePodInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeEmail200ResponsePodInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeEmail200ResponsePodInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeEmail200ResponsePodInfo>() {
           @Override
           public void write(JsonWriter out, ChangeEmail200ResponsePodInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeEmail200ResponsePodInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeEmail200ResponsePodInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeEmail200ResponsePodInfo
   * @throws IOException if the JSON string is invalid with respect to ChangeEmail200ResponsePodInfo
   */
  public static ChangeEmail200ResponsePodInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeEmail200ResponsePodInfo.class);
  }

  /**
   * Convert an instance of ChangeEmail200ResponsePodInfo to an JSON string
   *
   * @return JSON string
   */
