...
public class UserDetailsPodInfo {
  ...
  public UserDetailsPodInfo() {
  }

  public UserDetailsPodInfo floorId(@javax.annotation.Nonnull String floorId) {
  ...
  public UserDetailsPodInfo isOwner(@javax.annotation.Nullable String isOwner) {
  ...
  public UserDetailsPodInfo appId(@javax.annotation.Nullable String appId) {
    this.appId = appId;
    return this;
  }
  ...
  public UserDetailsPodInfo title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public UserDetailsPodInfo details(@javax.annotation.Nullable String details) {
  ...
  public UserDetailsPodInfo floorUid(@javax.annotation.Nonnull String floorUid) {
  ...
  public UserDetailsPodInfo blocks(@javax.annotation.Nonnull List<BlockDetails> blocks) {
    this.blocks = blocks;
    return this;
  }

  public UserDetailsPodInfo addBlocksItem(BlockDetails blocksItem) {
    if (this.blocks == null) {
  ...
  public UserDetailsPodInfo avatar(@javax.annotation.Nullable Media avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserDetailsPodInfo userDetailsPodInfo = (UserDetailsPodInfo) o;
    return Objects.equals(this.floorId, userDetailsPodInfo.floorId) &&
        Objects.equals(this.isOwner, userDetailsPodInfo.isOwner) &&
        Objects.equals(this.appId, userDetailsPodInfo.appId) &&
        Objects.equals(this.title, userDetailsPodInfo.title) &&
        Objects.equals(this.details, userDetailsPodInfo.details) &&
        Objects.equals(this.floorUid, userDetailsPodInfo.floorUid) &&
        Objects.equals(this.blocks, userDetailsPodInfo.blocks) &&
        Objects.equals(this.avatar, userDetailsPodInfo.avatar);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserDetailsPodInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserDetailsPodInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserDetailsPodInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserDetailsPodInfo is not found in the empty JSON string", UserDetailsPodInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserDetailsPodInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserDetailsPodInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserDetailsPodInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDetailsPodInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDetailsPodInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDetailsPodInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDetailsPodInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDetailsPodInfo>() {
           @Override
           public void write(JsonWriter out, UserDetailsPodInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDetailsPodInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserDetailsPodInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserDetailsPodInfo
   * @throws IOException if the JSON string is invalid with respect to UserDetailsPodInfo
   */
  public static UserDetailsPodInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDetailsPodInfo.class);
  }

  /**
   * Convert an instance of UserDetailsPodInfo to an JSON string
   *
   * @return JSON string
   */
