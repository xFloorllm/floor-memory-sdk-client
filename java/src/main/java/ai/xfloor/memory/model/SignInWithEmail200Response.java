...
public class SignInWithEmail200Response {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignInWithEmail200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignInWithEmail200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignInWithEmail200Response is not found in the empty JSON string", SignInWithEmail200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignInWithEmail200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignInWithEmail200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SignInWithEmail200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignInWithEmail200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignInWithEmail200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignInWithEmail200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignInWithEmail200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SignInWithEmail200Response>() {
           @Override
           public void write(JsonWriter out, SignInWithEmail200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignInWithEmail200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignInWithEmail200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignInWithEmail200Response
   * @throws IOException if the JSON string is invalid with respect to SignInWithEmail200Response
   */
  public static SignInWithEmail200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignInWithEmail200Response.class);
  }

  /**
   * Convert an instance of SignInWithEmail200Response to an JSON string
   *
   * @return JSON string
   */
