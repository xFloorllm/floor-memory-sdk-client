...
async function example() {
  ...
  const body = {
    ...
    // string | Validation code (optional)
    acticationCode: acticationCode_example,
...
| **newPassword** | `string` | New Password | [Optional] [Defaults to `undefined`] |
| **acticationCode** | `string` | Validation code | [Optional] [Defaults to `undefined`] |
