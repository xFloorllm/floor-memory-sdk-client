...
class TestFloorInfo(unittest.TestCase):
    """FloorInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloorInfo:
        """Test FloorInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloorInfo`
        """
        model = FloorInfo()
        if include_optional:
            return FloorInfo(
