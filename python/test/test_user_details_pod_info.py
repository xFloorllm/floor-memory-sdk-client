...
class TestUserDetailsPodInfo(unittest.TestCase):
    """UserDetailsPodInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserDetailsPodInfo:
        """Test UserDetailsPodInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserDetailsPodInfo`
        """
        model = UserDetailsPodInfo()
        if include_optional:
            return UserDetailsPodInfo(
                floor_id = '',
                is_owner = '',
                app_id = '',
                title = '',
    ...
    def testUserDetailsPodInfo(self):
        """Test UserDetailsPodInfo"""
