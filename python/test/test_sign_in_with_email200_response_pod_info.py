...
class TestSignInWithEmail200ResponsePodInfo(unittest.TestCase):
    """SignInWithEmail200ResponsePodInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignInWithEmail200ResponsePodInfo:
        """Test SignInWithEmail200ResponsePodInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignInWithEmail200ResponsePodInfo`
        """
        model = SignInWithEmail200ResponsePodInfo()
        if include_optional:
    ...
    def testSignInWithEmail200ResponsePodInfo(self):
        """Test SignInWithEmail200ResponsePodInfo"""
