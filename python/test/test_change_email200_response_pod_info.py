...
class TestChangeEmail200ResponsePodInfo(unittest.TestCase):
    """ChangeEmail200ResponsePodInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangeEmail200ResponsePodInfo:
        """Test ChangeEmail200ResponsePodInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeEmail200ResponsePodInfo`
        """
        model = ChangeEmail200ResponsePodInfo()
        if include_optional:
            return ChangeEmail200ResponsePodInfo(
                floor_id = '',
                is_owner = '',
                app_id = '',
                title = '',
    ...
    def testChangeEmail200ResponsePodInfo(self):
        """Test ChangeEmail200ResponsePodInfo"""
