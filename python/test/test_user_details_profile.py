...
class TestUserDetailsProfile(unittest.TestCase):
    """UserDetailsProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserDetailsProfile:
        """Test UserDetailsProfile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserDetailsProfile`
        """
        model = UserDetailsProfile()
        if include_optional:
    ...
    def testUserDetailsProfile(self):
        """Test UserDetailsProfile"""
