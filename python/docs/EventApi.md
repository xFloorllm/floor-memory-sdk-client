...
[**get_recent_events**](EventApi.md#get_recent_events) | **GET** /api/memory/recent/events | Recent Events
...
with xfloor_memory_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EventApi->get_recent_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventApi->get_recent_events: %s\n" % e)
```
