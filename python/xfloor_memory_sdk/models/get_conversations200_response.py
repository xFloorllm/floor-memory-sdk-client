...
class GetConversations200Response(BaseModel):
    """
    GetConversations200Response
    """ # noqa: E501
    user_id: StrictStr
    thread_id: StrictStr
    conversation: List[GetConversations200ResponseConversationInner]
    __properties: ClassVar[List[str]] = ["user_id", "thread_id", "conversation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversation": [GetConversations200ResponseConversationInner.from_dict(_item) for _item in obj["conversation"]] if obj.get("conversation") is not None else None
        })
        return _obj
