...
class GetConversations200ResponseConversationInner(BaseModel):
    """
    GetConversations200ResponseConversationInner
    """ # noqa: E501
    user: Optional[GetConversations200ResponseConversationInnerUser] = None
    assistant: Optional[GetConversations200ResponseConversationInnerAssistant] = None
    __properties: ClassVar[List[str]] = ["user", "assistant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": GetConversations200ResponseConversationInnerUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "assistant": GetConversations200ResponseConversationInnerAssistant.from_dict(obj["assistant"]) if obj.get("assistant") is not None else None
        })
        return _obj
