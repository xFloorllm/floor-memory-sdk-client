...
class GetRecentEvents200Response(BaseModel):
    """
    GetRecentEvents200Response
    """ # noqa: E501
    post_count: StrictStr = Field(description="Number of posts")
    items: List[GetRecentEvents200ResponseItemsInner] = Field(description="List of posts")
    __properties: ClassVar[List[str]] = ["post_count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [GetRecentEvents200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
