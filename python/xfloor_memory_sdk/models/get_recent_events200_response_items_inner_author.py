...
class GetRecentEvents200ResponseItemsInnerAuthor(BaseModel):
    """
    Author details
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the author")
    floor_id: Optional[StrictStr] = Field(default=None, description="Profile floor of the auther")
    avatar: Optional[Media] = None
    floor_uid: Optional[StrictStr] = Field(default=None, description="Unique 13 digit id of the profile floor")
    __properties: ClassVar[List[str]] = ["name", "floor_id", "avatar", "floor_uid"]
