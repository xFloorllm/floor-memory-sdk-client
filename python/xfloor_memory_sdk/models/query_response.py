...
class QueryResponse(BaseModel):
    ...
    QueryResponse
    """ # noqa: E501
    items: Optional[List[QueryResponseItemsInner]] = Field(default=None, description="List of source content")
    answer: Optional[StrictStr] = Field(default=None, description="Summary of the posts")
    __properties: ClassVar[List[str]] = ["items", "answer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [QueryResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
