...
class ConversationThreads200Response(BaseModel):
    """
    ConversationThreads200Response
    """ # noqa: E501
    user_id: StrictStr
    threads: List[ConversationThreads200ResponseThreadsInner]
    __properties: ClassVar[List[str]] = ["user_id", "threads"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "threads": [ConversationThreads200ResponseThreadsInner.from_dict(_item) for _item in obj["threads"]] if obj.get("threads") is not None else None
        })
        return _obj
