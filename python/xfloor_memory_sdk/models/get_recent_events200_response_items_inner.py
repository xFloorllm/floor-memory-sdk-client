...
class GetRecentEvents200ResponseItemsInner(BaseModel):
    """
    Each post item
    """ # noqa: E501
    event_id: Optional[StrictStr] = Field(default=None, description=" Post ID")
    block_type: Optional[StrictStr] = Field(default=None, description="Block Type")
    author: Optional[GetRecentEvents200ResponseItemsInnerAuthor] = None
    media: Optional[List[Media]] = Field(default=None, description="Any media attached")
    floor_uid: Optional[StrictStr] = Field(default=None, description="13 digit ID of the floor in which the post is residing")
    title: Optional[StrictStr] = Field(default=None, description="Post title")
    text: Optional[StrictStr] = Field(default=None, description="Post details")
    created_at_ms: Optional[StrictStr] = Field(default=None, description="Created time in milli seconds")
    block_id: Optional[StrictStr] = Field(default=None, description="Numeric ID of the block")
    __properties: ClassVar[List[str]] = ["event_id", "block_type", "author", "media", "floor_uid", "title", "text", "created_at_ms", "block_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": GetRecentEvents200ResponseItemsInnerAuthor.from_dict(obj["author"]) if obj.get("author") is not None else None,
