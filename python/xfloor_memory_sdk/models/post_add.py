...
class PostAdd(BaseModel):
    ...
    PostAdd
    """ # noqa: E501
    floor_id: StrictStr = Field(description="Floor ID to which the post needs to be added")
    bid: StrictStr = Field(description="Block type (0 or 1)", alias="BID")
    user_id: StrictStr = Field(description="User Identifcation who has added the post")
    title: StrictStr = Field(description="Title of the post")
    description: StrictStr = Field(description="Description or Details")
    __properties: ClassVar[List[str]] = ["floor_id", "BID", "user_id", "title", "description"]
