...
class ChangeEmail200ResponseProfile(BaseModel):
    """
    ...
    avatar: Optional[ChangeEmail200ResponseProfileAvatar] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": ChangeEmail200ResponseProfileAvatar.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None
        })
        return _obj
