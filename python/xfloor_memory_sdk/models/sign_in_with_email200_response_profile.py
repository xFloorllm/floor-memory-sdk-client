...
class SignInWithEmail200ResponseProfile(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": SignInWithEmail200ResponseProfileAvatar.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None
        })
        return _obj
