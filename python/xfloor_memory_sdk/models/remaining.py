...
class Remaining(BaseModel):
    ...
    Remaining
    """ # noqa: E501
    permitted: Optional[StrictStr] = None
    remaining: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["permitted", "remaining"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Remaining from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Remaining from a dict"""
        if obj is None:
            return None
