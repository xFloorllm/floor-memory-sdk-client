...
class QueryRequest(BaseModel):
    ...
    query: StrictStr = Field(description="Query text for conversations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": obj.get("query"),
            "floor_ids": obj.get("floor_ids"),
            "include_metadata": obj.get("include_metadata"),
            "summary_needed": obj.get("summary_needed"),
            "app_id": obj.get("app_id"),
            "filters": QueryRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
