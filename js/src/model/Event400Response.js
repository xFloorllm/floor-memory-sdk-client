...
import Event400ResponseError from './Event400ResponseError';
...
class Event400Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = Event400ResponseError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Event400Response.RequiredProperties) {
        ...
        if (data['error']) { // data not null
          Event400ResponseError.validateJSON(data['error']);
        }
...
export default Event400Response;
