...
import GetRecentEvents400ResponseError from './GetRecentEvents400ResponseError';
...
class GetRecentEvents400Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = GetRecentEvents400ResponseError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetRecentEvents400Response.RequiredProperties) {
        ...
        if (data['error']) { // data not null
          GetRecentEvents400ResponseError.validateJSON(data['error']);
        }
...
export default GetRecentEvents400Response;
