...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instance = new XfloorFloorMemorySdkJs.EventResponse();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.EventResponse);
    });
