...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.BlockDetails();
  });
  ...
  describe('BlockDetails', function() {
    it('should create an instance of BlockDetails', function() {
      // uncomment below and update the code to test BlockDetails
