...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.ChangeEmail200ResponsePodInfo();
  });
  ...
  describe('ChangeEmail200ResponsePodInfo', function() {
    it('should create an instance of ChangeEmail200ResponsePodInfo', function() {
      // uncomment below and update the code to test ChangeEmail200ResponsePodInfo
      //var instance = new XfloorFloorMemorySdkJs.ChangeEmail200ResponsePodInfo();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.ChangeEmail200ResponsePodInfo);
    });
