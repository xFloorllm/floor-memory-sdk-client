...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.ChangeEmail200ResponseProfile();
  });
  ...
  describe('ChangeEmail200ResponseProfile', function() {
    it('should create an instance of ChangeEmail200ResponseProfile', function() {
      // uncomment below and update the code to test ChangeEmail200ResponseProfile
      //var instance = new XfloorFloorMemorySdkJs.ChangeEmail200ResponseProfile();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.ChangeEmail200ResponseProfile);
    });
