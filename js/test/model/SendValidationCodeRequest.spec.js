...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.SendValidationCodeRequest();
  });
  ...
  describe('SendValidationCodeRequest', function() {
    it('should create an instance of SendValidationCodeRequest', function() {
      // uncomment below and update the code to test SendValidationCodeRequest
      //var instance = new XfloorFloorMemorySdkJs.SendValidationCodeRequest();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.SendValidationCodeRequest);
    });
