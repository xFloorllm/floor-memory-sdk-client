...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.SignInResponse();
  });
  ...
  describe('SignInResponse', function() {
    it('should create an instance of SignInResponse', function() {
      ...
      //var instance = new XfloorFloorMemorySdkJs.SignInResponse();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.SignInResponse);
    });
