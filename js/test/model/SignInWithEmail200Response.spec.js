...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.SignInWithEmail200Response();
  });
  ...
  describe('SignInWithEmail200Response', function() {
    it('should create an instance of SignInWithEmail200Response', function() {
      // uncomment below and update the code to test SignInWithEmail200Response
      //var instance = new XfloorFloorMemorySdkJs.SignInWithEmail200Response();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.SignInWithEmail200Response);
    });
