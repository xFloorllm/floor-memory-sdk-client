...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.FloorInfo();
  });
  ...
  describe('FloorInfo', function() {
    it('should create an instance of FloorInfo', function() {
      // uncomment below and update the code to test FloorInfo
      //var instance = new XfloorFloorMemorySdkJs.FloorInfo();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.FloorInfo);
    });
