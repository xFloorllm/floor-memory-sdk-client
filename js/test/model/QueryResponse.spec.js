...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.QueryResponse();
  });
  ...
  describe('QueryResponse', function() {
    it('should create an instance of QueryResponse', function() {
      ...
      //var instance = new XfloorFloorMemorySdkJs.QueryResponse();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.QueryResponse);
    });
