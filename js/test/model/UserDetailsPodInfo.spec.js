...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XfloorFloorMemorySdkJs.UserDetailsPodInfo();
  });
  ...
  describe('UserDetailsPodInfo', function() {
    it('should create an instance of UserDetailsPodInfo', function() {
      // uncomment below and update the code to test UserDetailsPodInfo
      //var instance = new XfloorFloorMemorySdkJs.UserDetailsPodInfo();
      //expect(instance).to.be.a(XfloorFloorMemorySdkJs.UserDetailsPodInfo);
    });
