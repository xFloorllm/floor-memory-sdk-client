...
> ChangePassword200Response changePassword(opts)
...
let opts = {
  ...
  'acticationCode': "acticationCode_example" // String | Validation code
};
apiInstance.changePassword(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
